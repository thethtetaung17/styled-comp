import React, { useRef, useDebugValue, useContext, createElement, useCallback, useLayoutEffect, useEffect, useMemo, Children, isValidElement, cloneElement, useState, memo, forwardRef, useImperativeHandle } from 'react';
...
const CxStyButton = () => {
    return React.createElement(Button$1, null, "This is a button!!!");
};
const CxStyButtonMat = Ye(Button$1) `
    text-transform: none;
    font-weight: 700;
`;
const CxStyActionButton = Ye(({ ...props }) => (React.createElement(CxStyButtonMat, Object.assign({ variant: "contained" }, props)))) `
    background: #78B0FA;
    color: #FFFFFF;
    &:hover {
...
export { CxStyActionButton, CxStyButton };
